...
if __name__ == "__main__":
    detector = HornSchunckPositionDetector(
        video_path="data/demo1.mp4",
        output_dir="frames/horn_schunck/demo1",
        alpha=1.0,
        num_iter=100
    )
    ...
    vc = VideoCreator(frame_dir, output_path="output/demo1_output_horn_schunck.avi", fps=30)
    output_mpeg4_file = vc.create_video()
    output_mp4_file = convert_to_modern_mp4(output_mpeg4_file, "output/demo1_output_horn_schunck.mp4")
